...
public class SpitterDaoImplWithTempl extends NamedParameterJdbcDaoSupport implements SpitterDao{
    ...
    private final String SQL_UPDATE_SPITTER =
            "update spitter set username = :username, full_name = :full_name, password = :password," +
                    " email = :email, update_by_email = :update_by_email" +
                    " where id = :id";
    ...
    public void updateSpitter(Spitter spitter) {
        ...
        getNamedParameterJdbcTemplate().update(SQL_UPDATE_SPITTER,params);
